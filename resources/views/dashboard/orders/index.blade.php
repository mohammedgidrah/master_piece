                                    ...
                                    <div class="modal-content">
                                                ...
                                                @foreach ($orderGroup as $order)
                                                    <li class="d-flex align-items-center mb-2">
                                                        ...
                                                        <form id="delete-product-form-{{ $order->id }}"
                                                            action="{{ route('ordersdash.deleteProduct', $order->id) }}" method="POST" class="ms-2" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#" class="text-danger" title="Delete Product" onclick="event.preventDefault(); document.getElementById('delete-product-form-{{ $order->id }}').submit();">
                                        ...
                                        <div class="modal-footer">
                                            <form id="delete-order-form-{{ $firstOrder->order_id }}"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('delete-order-form-{{ $firstOrder->order_id }}').submit();">
                                                    Delete all Orders
                                                </button>
                                            </form>
