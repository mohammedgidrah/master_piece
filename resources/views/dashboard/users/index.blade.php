                    ...
                    @if ($users->isNotEmpty())
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    {{-- <img src="{{ $user->image ?? asset('path/to/default/image.png') }}" style="width: 50px; height: auto; border-radius: 50%;"> --}}
                                    <img src="{{ asset('storage/' . $user->image) }}" alt="{{ $user->first_name }} {{ $user->last_name }}" style="width: 50px; height: auto; border-radius: 50%;"  />
                                ...
                                <td>
                                    <div class="form-button-action">
                                        <a href="{{ route('users.edit', $user->id) }}" class="btn btn-link btn-primary btn-lg" data-original-title="Edit User">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $user->id }}').submit();" class="btn btn-link btn-danger btn-lg" data-original-title="Delete User">
